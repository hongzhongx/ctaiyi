import type * as ByteBuffer from 'bytebuffer'
...
function VoidSerializer(buffer: ByteBuffer) {
...
function OperationDataSerializer(operationId: number, definitions: Array<[string, Serializer]>) {
